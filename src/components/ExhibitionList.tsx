  ...
  return (
    <section>
      ...
      <div className="text-center mb-8 sm:mb-16">
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 tracking-tight leading-tight">
      ...
      <div className="flex justify-center mb-8 sm:mb-12 px-4">
        <div className="bg-gray-100 rounded-full p-1 flex flex-wrap sm:flex-nowrap gap-1 sm:gap-0">
          <button
          ...
          >
            {currentLanguage === 'it' ? 'Temporanee' : 'Temporary'}
          </button>
          <button
          ...
          >
            {currentLanguage === 'it' ? 'Permanenti' : 'Museums'}
          </button>
        </div>
      </div>
      ...
      {/* CTA Section */}
      <div className="text-center mt-12 sm:mt-20 p-6 sm:p-12 bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 rounded-2xl sm:rounded-3xl border border-gray-100 mx-4 sm:mx-0">
        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t.experiences.readyTitle}</h3>
        <p className="text-slate-600 mb-6 sm:mb-8 max-w-2xl mx-auto text-sm sm:text-base px-2">
          {t.experiences.readyDescription}
        </p>
        <div className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded-full font-medium hover:from-slate-800 hover:to-slate-700 transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base">
...
const ExhibitionCard: React.FC<{
  ...
  return (
    <div className="group bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-gray-200">
      {/* Image */}
        ...
        {exhibition.dates && (
          <div className="absolute top-2 sm:top-3 right-2 sm:right-3">
            <div className="bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-medium text-gray-800 flex items-center">
              ...
              <span className="hidden sm:inline">{exhibition.dates}</span>
              <span className="sm:hidden">{exhibition.dates.split(' ').slice(0, 2).join(' ')}</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <div className="flex items-center text-xs sm:text-sm text-slate-500">
            ...
            <span className="truncate">{exhibition.venue.name}</span>
          </div>
        </div>

        <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3 group-hover:text-slate-700 transition-colors line-clamp-2">
          {exhibition.title}
        </h3>
        ...
        <div className="space-y-2">
          <div className="flex gap-1 sm:gap-2">
            <a
              ...
              className="flex-1 bg-slate-900 text-white text-xs sm:text-sm font-medium py-2 px-2 sm:px-4 rounded-lg hover:bg-slate-800 transition-colors flex items-center justify-center"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-gray-100 text-gray-700 text-xs sm:text-sm font-medium py-2 px-2 sm:px-4 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center"
              onClick={(e) => e.stopPropagation()}
            >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-slate-50 to-gray-50 text-slate-700 text-xs sm:text-sm font-medium py-2 px-3 sm:px-4 rounded-lg hover:from-slate-100 hover:to-gray-100 transition-all flex items-center justify-center group-hover:shadow-md"
          >
