...
const ExhibitionDetail: React.FC<ExhibitionDetailProps> = ({ exhibitionId, onBack }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <button
        onClick={onBack}
        className="flex items-center text-gray-600 hover:text-gray-900 mb-12 font-medium transition-colors group"
      >
          ...
          <div className="absolute bottom-8 left-8 text-white">
            <div className="flex items-center mb-4">
              ...
              {exhibitionDetails.dates && (
                <div className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium flex items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {exhibitionDetails.highlights.map((highlight, idx) => (
                    <div key={idx} className="flex items-start">
                      <div className="w-2 h-2 bg-slate-600 rounded-full mt-2 mr-3 flex-shrink-0" />
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a
                ...
                className="bg-slate-900 text-white font-medium py-4 px-6 rounded-xl hover:bg-slate-800 transition-colors flex items-center justify-center group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-100 text-gray-700 font-medium py-4 px-6 rounded-xl hover:bg-gray-200 transition-colors flex items-center justify-center group"
              >
            ...
            <div className="mt-8 pt-8 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-red-500 hover:bg-red-600 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-blue-800 hover:bg-blue-900 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                >
                  <ExternalLink className="w-4 h-4 mr-2" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-yellow-600 hover:bg-yellow-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                >
                  <ExternalLink className="w-4 h-4 mr-2" />
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4">
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center">
                  <Euro className="w-4 h-4 text-gray-600 mr-1" />
                  <span className="text-2xl font-bold text-gray-900">€{estimatedStayPrice}</span>
                </div>
              </div>
